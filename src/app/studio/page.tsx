...
export default function StudioPage() {
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#101010] text-sand">
            ...
            <main className="relative z-10 mx-auto flex min-h-[calc(100dvh-160px)] w-full max-w-3xl flex-col items-center justify-center px-5 text-center md:min-h-[calc(100dvh-96px)]">
